...
def getTuitionListings(studentType, moduleCode, moduleName, ratings):
    ...
    if isValidQuery(studentType):
        allListings = allListings.filter(typeOfStudent=studentType)
...
class ListingCreateView(LoginRequiredMixin, CreateView):
    model = Listing
    fields = ['title', 'description', 'module', 'typeOfStudent']
    
    # #Change type of student to radio buttons
